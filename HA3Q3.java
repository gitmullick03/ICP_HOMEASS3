/*
 Program: Write a java program that randomly generates an integer between 1 and 12 
 		  and displays the English month name January, February… December for the 
...
public class HA3Q3 
{
	public static void main(String z[])
	{
		...
		System.out.println("Generated number: "+j);
		switch (j)
		{
		case (1):
